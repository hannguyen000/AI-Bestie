...
const CHARACTER_IMAGES: Record<string, string> = {
  ...
  mystic:   "https://ymivxyrrshkpyyrkndgu.supabase.co/storage/v1/object/public/system-assets/aura_mentor.png", // Dùng tạm ảnh mentor hoặc linh vật riêng của bạn
  solar:    "https://ymivxyrrshkpyyrkndgu.supabase.co/storage/v1/object/public/system-assets/aura_sunshine.png",
  sunshine: "https://ymivxyrrshkpyyrkndgu.supabase.co/storage/v1/object/public/system-assets/aura_sunshine.png",
}

export function CharacterIllustration({ variant = 'default', className = '', animate = true }: CharacterProps) {
  ...
  return (
    <div className={`relative flex items-center justify-center ${animate ? 'animate-float' : ''} ${className}`}>
...
export function Sparkles() {
  return (
    <>
      <span className="sparkle text-xl"
        style={{ top: '8%',  left: '10%',  animationDelay: '0s'    }}>✦</span>
      <span className="sparkle text-sm"
        style={{ top: '15%', right: '12%', animationDelay: '0.6s'  }}>✦</span>
      <span className="sparkle text-lg"
        style={{ top: '70%', left: '8%',   animationDelay: '1.1s'  }}>✦</span>
      <span className="sparkle text-xs"
        style={{ top: '80%', right: '15%', animationDelay: '0.3s'  }}>✦</span>
      <span className="sparkle text-base"
        style={{ top: '45%', right: '6%',  animationDelay: '1.5s'  }}>✦</span>
    </>
  )
}
...
export function InputField({ icon, label, className = '', ...props }: InputFieldProps) {
  return (
    <div className="relative group">
      ...
      <div className="relative">
        ...
        <input
          className={`input-aura pl-11 ${className}`}
          {...props}
        />
      </div>
    </div>
